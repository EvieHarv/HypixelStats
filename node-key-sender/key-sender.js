...
module.exports = function() {
    ...
    module.execute = function(arrParams) {
        return new Promise(function(resolve, reject) {
            ...
            if (__dirname.includes('app.asar')) // Only thing added by EthanHarv - A slightly strange way to check if we're in the published executable
            {
                jarPath = path.join(__dirname.split("app.asar")[0], 'key-sender.jar');
            }
